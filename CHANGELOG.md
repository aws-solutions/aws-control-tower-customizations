...
## [2.8.6] - 2026-07-01
- Add `codeconnections:*` permissions to the CfCT CodePipeline role alongside the existing `codestar-connections:*` permissions, so pipelines using a GitHub connection continue to work after the AWS CodeConnections cross-account authorization change.
