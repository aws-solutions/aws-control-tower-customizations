...
class CFNParamsHandler(object):
    ...
    def update_params(self, params_in, account=None, region=None,
        ...
        for param in params_in:
            ...
            if not isinstance(value, list):
                value = self._process_alfred_helper(param, key, value, account, region, substitute_ssm_values)
            else:
                new_value_list = []
                for nested_value in value:
                    new_value_list.append(self._process_alfred_helper(param, key, nested_value, account, region, substitute_ssm_values))
    ...
    def _process_alfred_helper(self, param, key, value, account=None, region=None,
                               substitute_ssm_values=True):
